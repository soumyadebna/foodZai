...
import 'package:foodai/screens/height_input_screen.dart';
...
class _WeightInputScreenState extends State<WeightInputScreen> {
  ...
  final List<String> _units = ['lbs', 'kg', 'st'];
  ...
  void _navigateToNextScreen() {
    if (_weightController.text.isEmpty) {
      // Show a snackbar if no weight is entered
    ...
    // Parse weight value
    final double weightValue = double.tryParse(_weightController.text) ?? 0;
    ...
    // Log for debugging
    debugPrint('Weight selected: ${_weightController.text} $_selectedUnit');
  }
