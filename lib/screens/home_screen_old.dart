...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadUserData() async {
    ...
    // Don't set loading state here to avoid blocking interactions
    // We'll show a progress indicator in specific sections instead
  ...
  Future<void> _navigateToVoiceInput(String mealType) async {
    ...
    try {
      ...
      // We don't need to reset loading state here since we didn't set it
    }
  }
  ...
  Widget _buildHomeTab() {
    ...
    // Use a CustomScrollView with SliverAppBar and SliverList for better scrolling
      ...
      children: [
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemCount: 7,
            // Use ClampingScrollPhysics for better horizontal scrolling
            physics: const ClampingScrollPhysics(),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: PageView(
              ...
              // Use NeverScrollableScrollPhysics to prevent conflicts with main scroll
              // Users can tap the dots to change pages instead
  ...
  Widget _buildTodaysDiarySection(Color? backgroundColor, Color textColor, Color subtitleColor, List<FoodItem> foodItems) {
    ...
    return Container(
      ...
      child: ListView.builder(
        shrinkWrap: true,
        // Use NeverScrollableScrollPhysics to prevent nested scrolling conflicts
        physics: const NeverScrollableScrollPhysics(),
